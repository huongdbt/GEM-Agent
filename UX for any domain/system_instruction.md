...
"Tôi định [DESIGN DECISION]. Có pattern nào hỗ trợ hay bác bỏ điều này?"

// Tìm cách thích ứng văn hóa
"Pattern của [BRAND] có apply được cho user [THỊ TRƯỜNG] không?"

// Anti-pattern warning
"Tôi thấy nhiều app dùng [PATTERN]. Có evidence nào cho thấy đây là bad idea với [CONTEXT] không?"
```
